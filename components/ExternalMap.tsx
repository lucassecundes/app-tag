...
const MockMap = ({ children, style }: any) => (
  <View style={[styles.container, style]}>
    <Text style={styles.text}>Mapbox não disponível no Expo Go.</Text>
    <Text style={styles.subtext}>Use uma Development Build ou o Simulador Web.</Text>
    {children}
  </View>
);
...
export const Camera = isExpoGo ? () => null : Mapbox.Camera;
export const PointAnnotation = isExpoGo ? () => null : Mapbox.PointAnnotation;
